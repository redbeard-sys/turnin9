...
app.get('/', function(req, res){
  var nation = 'select country from l9_author';
    connection.query(nation, function(error, results) {
...
app.get('/author', function(req, res){
    var blah = 'select * from l9_author where firstName=\'' 
                + req.query.firstname + '\' and lastName=\'' 
                + req.query.lastname + '\';'
	connection.query(blah, function(error, found){
	    var author = null;
	    if(error) throw error;
	    if(found.length){
	        author = found[0];
